...
' or failure. Note that this function does not clear the error. The caller is 
' responsible for calling Err.Clear when desired.
'
' Arguments:
...
'
' Logs the success of failure of an operation and clears the error. Err.Number 
' is used to test success or failure.
'
' Arguments:
' - sOperation - a textual description of the operation.
'
